...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 34 bc             	add    BYTE PTR [rsp+rdi*4],dh
 37a:	ea                   	(bad)  
 37b:	92                   	xchg   edx,eax
 37c:	ec                   	in     al,dx
 37d:	30 9a dc 7d cb 81    	xor    BYTE PTR [rdx-0x7e348224],bl
 383:	59                   	pop    rcx
 384:	23 27                	and    esp,DWORD PTR [rdi]
 386:	a8 2d                	test   al,0x2d
 388:	21 30                	and    DWORD PTR [rax],esi
 38a:	ae                   	scas   al,BYTE PTR es:[rdi]
 38b:	97                   	xchg   edi,eax
...
0000000000001070 <_start>:
    ...
    1088:	48 8d 3d 77 01 00 00 	lea    rdi,[rip+0x177]        # 1206 <main>
...
0000000000001159 <solver>:
    ...
    11b5:	48 8d 05 54 0e 00 00 	lea    rax,[rip+0xe54]        # 2010 <_IO_stdin_used+0x10>
    ...
    11d1:	48 05 ab 00 00 00    	add    rax,0xab
    11d7:	48 8b 55 e8          	mov    rdx,QWORD PTR [rbp-0x18]
    11db:	48 89 c6             	mov    rsi,rax
    11de:	48 8d 05 37 0e 00 00 	lea    rax,[rip+0xe37]        # 201c <_IO_stdin_used+0x1c>
    11e5:	48 89 c7             	mov    rdi,rax
    11e8:	b8 00 00 00 00       	mov    eax,0x0
    11ed:	ff d2                	call   rdx
    11ef:	90                   	nop
    11f0:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
    11f4:	64 48 2b 04 25 28 00 	sub    rax,QWORD PTR fs:0x28
    11fb:	00 00 
    11fd:	74 05                	je     1204 <solver+0xab>
    11ff:	e8 5c fe ff ff       	call   1060 <__stack_chk_fail@plt>
    1204:	c9                   	leave  
    1205:	c3                   	ret    
...
0000000000001206 <main>:
    ...
    120a:	55                   	push   rbp
    120b:	48 89 e5             	mov    rbp,rsp
    120e:	48 83 ec 20          	sub    rsp,0x20
    1212:	64 48 8b 04 25 28 00 	mov    rax,QWORD PTR fs:0x28
    1219:	00 00 
    121b:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
    121f:	31 c0                	xor    eax,eax
    1221:	48 b8 2a 2a 20 6d 61 	movabs rax,0x206e69616d202a2a
    1228:	69 6e 20 
    122b:	48 ba 3d 20 25 70 0a 	movabs rdx,0xa7025203d
    1232:	00 00 00 
    1235:	48 89 45 e0          	mov    QWORD PTR [rbp-0x20],rax
    1239:	48 89 55 e8          	mov    QWORD PTR [rbp-0x18],rdx
    123d:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    1241:	48 8d 15 be ff ff ff 	lea    rdx,[rip+0xffffffffffffffbe]        # 1206 <main>
    ...
    1258:	48 8b 05 81 2d 00 00 	mov    rax,QWORD PTR [rip+0x2d81]        # 3fe0 <printf@GLIBC_2.2.5>
    125f:	48 89 c7             	mov    rdi,rax
    1262:	e8 f2 fe ff ff       	call   1159 <solver>
    1267:	b8 00 00 00 00       	mov    eax,0x0
    126c:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
    1270:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
    1277:	00 00 
    1279:	74 05                	je     1280 <main+0x7a>
    127b:	e8 e0 fd ff ff       	call   1060 <__stack_chk_fail@plt>
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
0000000000002000 <_IO_stdin_used>:
    ...
    2007:	61                   	(bad)  
    2008:	72 79                	jb     2083 <__GNU_EH_FRAME_HDR+0x53>
    200a:	3a 20                	cmp    ah,BYTE PTR [rax]
    200c:	25 70 0a 00 72       	and    eax,0x72000a70
    2011:	62                   	(bad)  
    2012:	70 3a                	jo     204e <__GNU_EH_FRAME_HDR+0x1e>
    2014:	20 20                	and    BYTE PTR [rax],ah
    2016:	20 20                	and    BYTE PTR [rax],ah
    2018:	25 70 0a 00 72       	and    eax,0x72000a70
    201d:	65 74 75             	gs je  2095 <__GNU_EH_FRAME_HDR+0x65>
    2020:	72 6e                	jb     2090 <__GNU_EH_FRAME_HDR+0x60>
    2022:	5f                   	pop    rdi
    2023:	61                   	(bad)  
    2024:	64 64 72 65          	fs fs jb 208d <__GNU_EH_FRAME_HDR+0x5d>
    2028:	73 73                	jae    209d <__GNU_EH_FRAME_HDR+0x6d>
    202a:	3a 20                	cmp    ah,BYTE PTR [rax]
    202c:	25                   	.byte 0x25
    202d:	70 0a                	jo     2039 <__GNU_EH_FRAME_HDR+0x9>
	...
...
0000000000002030 <__GNU_EH_FRAME_HDR>:
    ...
    203d:	ef                   	out    dx,eax
    203e:	ff                   	(bad)  
    203f:	ff 70 00             	push   QWORD PTR [rax+0x0]
    2042:	00 00                	add    BYTE PTR [rax],al
    2044:	10 f0                	adc    al,dh
    2046:	ff                   	(bad)  
    2047:	ff 98 00 00 00 30    	call   FWORD PTR [rax+0x30000000]
    204d:	f0 ff                	lock (bad) 
    204f:	ff b0 00 00 00 40    	push   QWORD PTR [rax+0x40000000]
    2055:	f0 ff                	lock (bad) 
    2057:	ff 58 00             	call   FWORD PTR [rax+0x0]
    205a:	00 00                	add    BYTE PTR [rax],al
    205c:	29 f1                	sub    ecx,esi
    205e:	ff                   	(bad)  
    205f:	ff c8                	dec    eax
    2061:	00 00                	add    BYTE PTR [rax],al
    2063:	00 d6                	add    dh,dl
    2065:	f1                   	int1   
    2066:	ff                   	(bad)  
    2067:	ff                   	(bad)  
    2068:	e8                   	.byte 0xe8
...
0000000000002070 <__FRAME_END__-0xc8>:
    ...
    2090:	e0 ef                	loopne 2081 <__GNU_EH_FRAME_HDR+0x51>
    2092:	ff                   	(bad)  
    ...
    20a8:	78 ef                	js     2099 <__GNU_EH_FRAME_HDR+0x69>
    20aa:	ff                   	(bad)  
    ...
    20e4:	74 00                	je     20e6 <__GNU_EH_FRAME_HDR+0xb6>
    20e6:	00 00                	add    BYTE PTR [rax],al
    20e8:	78 ef                	js     20d9 <__GNU_EH_FRAME_HDR+0xa9>
    20ea:	ff                   	(bad)  
...
0000000000003dc0 <_DYNAMIC>:
    ...
    3de7:	00 84 12 00 00 00 00 	add    BYTE PTR [rdx+rdx*1+0x0],al
